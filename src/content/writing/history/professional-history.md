---
title: "Thirty Years at the Intersection"
description: "Career history from CD-ROM and early internet video through programmatic advertising, fintech, and AI governance."
date: 2026-03-15
...
Six years at Turner was the deepest technical chapter of my product career. My job was to build and optimize the advertising infrastructure across Turner's sports and entertainment brands — dozens of websites, mobile applications, and OTT platforms — supporting $400M+ in annual revenue.
...
At Steadyapp, a FinTech startup, I led product for the growth team — collaborating with internal development, vendors and partners to create new capabilities and features — partner marketing programs, referrals, fraud prevention, and a multi-channel messaging strategy across email, push, and SMS. We doubled the installed base to one million users. The company raised $35M across its Series B and C.
...
The most technically interesting work was building an agentic LLM-powered intake workflow that automated project charter and requirements generation. That led me into the AI governance questions I'd been circling for years: serving on a working group defining client data governance standards, developing training on AI ethics, algorithmic bias, and intellectual property risk.
